...
typedef struct indigo_dpa_port_state_s {
    uint32_t port;
	unsigned reason;
	uint8_t link_state;
    uint8_t isPortConfigured; /*it will be set to 0xff */
    uint8_t macAddress[6];
    uint8_t simPortDownUp; /*0-means down, 1 means up 0xff means not enable */
} indigo_dpa_port_state_t;
indigo_dpa_port_state_t g_of_port_status[113];
...
/*****************************************************************//**
* @brief  Add MPLS Set QoS action entry.
*
* @param[in]    mplsQosEntry   structure containing action entry parameters
*
* @retval   OFDPA_E_NONE  action entry added successfully
* @retval   OFDPA_E_PARAM error in parameters passed to function
* @retval   OFDPA_E_FULL  MPLS Set QoS Action table full
* @retval   OFDPA_E_EXISTS  action entry exists
* @retval   OFDPA_E_INTERNAL  internal error
*
*********************************************************************/
...
/*****************************************************************//**
* @brief  Delete MPLS Set QoS action entry.
*
* @param[in]    mplsQosEntry   structure containing action entry parameters
*
* @retval   OFDPA_E_NONE  entry deleted successfully
* @retval   OFDPA_E_PARAM error in parameters passed to function
* @retval   OFDPA_E_NOT_FOUND  entry not found
* @retval   OFDPA_E_FAIL  failure; other errors
*
*********************************************************************/
...
/*****************************************************************//**
* @brief  Get MPLS Set QoS action entry.
*
* @param[in]    qosIndex         QoS index
* @param[in]    mpls_tc          value from label shim header
* @param[out]   mplsQosEntry     structure containing action entry parameters
*
* @retval   OFDPA_E_NONE         entry returned successfully
* @retval   OFDPA_E_NOT_FOUND    entry not found
* @retval   OFDPA_E_PARAM        error in parameters passed to function
*
*********************************************************************/
...
/*****************************************************************//**
* @brief Retrieve the next MPLS QoS entry. This API allows the client
*        to walk the entries in a MPLS Set QoS table. In order to get the
*        first entry in a MPLS Set QoS table, the client calls with all
*        parameters set to zero.  Table entries are walked in the
*        order the table is indexed.  If there are no entries in the
*        table after the entry specified, a return code indicates the
*        end of the MPLS Set QoS table has been reached
*
* @param[in]    mplsQosEntry  structure containing action entry parameters
* @param[out]   nextEntry     structure containing the next MPLS Set QoS
*                                 table entry, if any
*
* @retval   OFDPA_E_NONE  the next action entry was found and returned
* @retval   OFDPA_E_PARAM error in action entry parameters passed to function
* @retval   OFDPA_E_NOT_FOUND  no next action entry found
*
*********************************************************************/
OFDPA_ERROR_t ofdpaMplsQosEntryNextGet(ofdpaMplsQosEntry_t *mplsQosEntry, ofdpaMplsQosEntry_t *nextEntry);

/*****************************************************************//**
* @brief  Initialize MPLS QoS entry.
*
* @param[in,out]    mplsQosEntry     MPLS QoS entry
*
* @retval   OFDPA_E_PARAM error in parameters passed to function
*
*********************************************************************/
