...
typedef enum
{
    ...
    */
    ...
    /*! Recursion detected while processing API in send done function.   Invalid API context.   Applications are not
     * allowed to call any variation of task_send in send_done context.   Additionally, applications are not allowed to
