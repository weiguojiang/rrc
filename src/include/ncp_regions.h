...
#include "ncp_axis_apb2ser2_regions.h"
#include "ncp_axis_apb2ser3_regions.h"
#include "ncp_axis_apb2ser_clk_3500_regions.h"
...
#define NCP_REGION_EIOA_PHY_0             (NCP_REGION_ID(0x110,  0))
#define NCP_REGION_EIOA_PHY_1             (NCP_REGION_ID(0x111,  0))
#define NCP_REGION_EIOA_PHY_2             (NCP_REGION_ID(0x112,  0))
#define NCP_REGION_EIOA_PHY_3             (NCP_REGION_ID(0x113,  0))
#define NCP_REGION_EIOA_PHY_4             (NCP_REGION_ID(0x114,  0))
...
#define NCP_REGION_STM                    (NCP_REGION_ID(0x127,  0)) /* 295.0 */
...
#define NCP_REGION_SRIO_GPREG             (NCP_REGION_ID(0x14f,  0)) /* 335.0 */
...
#define NCP_REGION_X7_ELM_0               (NCP_REGION_ID(0x158,  0)) /* 344.0 */
#define NCP_REGION_X7_ELM_1               (NCP_REGION_ID(0x159,  0)) /* 345.0 */
...
/* AXM56xx */
#define NCP_REGION_AXI2SER4_CPM           (NCP_REGION_ID(0x164,  0)) /* 356.0 */
#define NCP_REGION_AXI2SER5               (NCP_REGION_ID(0x165,  0)) /* 357.0 */
#define NCP_REGION_AXI2SER6_USB           (NCP_REGION_ID(0x166,  0)) /* 358.0 */
#define NCP_REGION_AXI2SER7_ELM           (NCP_REGION_ID(0x167,  0)) /* 358.0 */
#define NCP_REGION_ELM_0                  (NCP_REGION_ID(0x167,  0)) /* 359.0 */
#define NCP_REGION_ELM_1                  (NCP_REGION_ID(0x167,  1)) /* 359.0 */
#define NCP_REGION_AXI2SER8_NCAP          (NCP_REGION_ID(0x168,  0)) /* 360.0 */
#define NCP_REGION_AXI2SER9_CDC           (NCP_REGION_ID(0x169,  0)) /* 361.0 */
#define NCP_REGION_AXI2SER10_NLINK        (NCP_REGION_ID(0x16a,  0)) /* 362.0 */
#define NCP_REGION_AXI2SER11              (NCP_REGION_ID(0x16b,  0)) /* 363.0 */

#define NCP_REGION_AXI_MMAP_GPREG         (NCP_REGION_ID(0x170,  0)) /* 368.0 */
#define NCP_REGION_AXI_MMAP_SCB           (NCP_REGION_ID(0x170,  1)) /* 368.1 */
#define NCP_REGION_AXI_PERIPH_GPREG       (NCP_REGION_ID(0x171,  0)) /* 369.0 */
#define NCP_REGION_AXI_PERIPH_SCB         (NCP_REGION_ID(0x171,  1)) /* 369.1 */
#define NCP_REGION_AXI_PCI_GPREG          (NCP_REGION_ID(0x172,  0)) /* 370.0 */
#define NCP_REGION_AXI_PCI_SCB            (NCP_REGION_ID(0x172,  1)) /* 370.1 */
#define NCP_REGION_AXI_USB_GPREG          (NCP_REGION_ID(0x173,  0)) /* 371.0 */
#define NCP_REGION_AXI_USB_SCB            (NCP_REGION_ID(0x173,  1)) /* 371.1 */
...
/* 3500 */
#define NCP_REGION_L2_4                   (NCP_REGION_ID(0x1a1,  0)) /* 417.0 */
#define NCP_REGION_L2_4_INDIRECT          (NCP_REGION_ID(0x1a1,  1)) /* 417.1 */
#define NCP_REGION_L2_4_PMU               (NCP_REGION_ID(0x1a1,  2)) /* 417.2 */
#define NCP_REGION_L2_5                   (NCP_REGION_ID(0x1a2,  0)) /* 418.0 */
#define NCP_REGION_L2_5_INDIRECT          (NCP_REGION_ID(0x1a2,  1)) /* 418.1 */
#define NCP_REGION_L2_5_PMU               (NCP_REGION_ID(0x1a2,  2)) /* 418.2 */
#define NCP_REGION_L2_4_TRACE             (NCP_REGION_ID(0x1a3,  0)) /* 419.0 */
#define NCP_REGION_L2_4_TRACE_INDIRECT    (NCP_REGION_ID(0x1a3,  1)) /* 419.1 */
#define NCP_REGION_L2_5_TRACE             (NCP_REGION_ID(0x1a4,  0)) /* 420.0 */
#define NCP_REGION_L2_5_TRACE_INDIRECT    (NCP_REGION_ID(0x1a4,  1)) /* 420.1 */
...
#define NCP_REGION_TZC_0                  (NCP_REGION_ID(0x1d2,  0)) /* 466.0 */
#define NCP_REGION_LBI                    (NCP_REGION_ID(0x1d3,  0)) /* 467.0 */
#define NCP_REGION_TZC_1                  (NCP_REGION_ID(0x1d4,  0)) /* 468.0 */
...
/* Lionfish */
#define NCP_REGION_CDC0_CORE(n)           (NCP_REGION_ID(0x1f0, n)) /* 496.n */
#define NCP_REGION_CDC1_CORE(n)           (NCP_REGION_ID(0x1f1, n)) /* 497.n */
#define NCP_REGION_CDC2_CORE(n)           (NCP_REGION_ID(0x1f2, n)) /* 498.n */
#define NCP_REGION_CDC3_CORE(n)           (NCP_REGION_ID(0x1f3, n)) /* 499.n */
#define NCP_REGION_CDC_CORE(_cdc, _ceva)  (NCP_REGION_ID((0x1f0 + _cdc), _ceva);
...
#define NCP_REGION_DRIVER_SWSTATE         (NCP_REGION_ID(0x305,  0)) 
