...
/* @(#) $Revision: 1.4 $ $Source: /export/cvsroot/sw/src/com/agere/runtime/external/judy/src/Judy.h,v $ */
/* */
...
#if (defined JU_WIN) || (defined WIN32 && !(defined __GNUC__)) /* =============================================== */
...
#ifdef AG_INTERNAL_HOST_PROCESSOR
...
#endif /* AG_INTERNAL_HOST_PROCESSOR */

#elif defined(NCP_OSE)
