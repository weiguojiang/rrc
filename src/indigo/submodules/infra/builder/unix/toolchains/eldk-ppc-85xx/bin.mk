...
$(BINARY_DIR)/$(BINARY): $($(BINARY)_LIBRARIES)
	...
	$(VERBOSE)$(GCC) $(DEBUG_FLAGS) $(COVERAGE_FLAGS) -o $@ $($(BINARY)_LINK_LIBS) $(GLOBAL_LINK_LIBS) $($(BINARY)_LINK_LIBS) $(GLOBAL_LINK_LIBS) $($(BINARY)_LINK_LIBS) $(GLOBAL_LINK_LIBS) $(LDFLAGS)
