...
public class OFBsnPortVxlanModeSerializerVer14 {
    ...
    public static OFBsnPortVxlanMode ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnPortVxlanMode in version 1.4: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnPortVxlanMode e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnPortVxlanMode in version 1.4: " + e);
        }
    }
