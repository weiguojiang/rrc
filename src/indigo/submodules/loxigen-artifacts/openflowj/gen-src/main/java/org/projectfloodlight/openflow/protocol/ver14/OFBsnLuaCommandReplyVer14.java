...
class OFBsnLuaCommandReplyVer14 implements OFBsnLuaCommandReply {
...
//
    ...
    final static OFBsnLuaCommandReplyVer14 DEFAULT = new OFBsnLuaCommandReplyVer14(
        DEFAULT_XID, DEFAULT_DATA
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnLuaCommandReplyVer14(long xid, byte[] data) {
        if(data == null) {
    ...
    static class BuilderWithParent implements OFBsnLuaCommandReply.Builder {
        ...
        BuilderWithParent(OFBsnLuaCommandReplyVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnLuaCommandReply> {
        @Override
        public OFBsnLuaCommandReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnLuaCommandReplyVer14 bsnLuaCommandReplyVer14 = new OFBsnLuaCommandReplyVer14(
                    xid,
                      data
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnLuaCommandReplyVer14);
            return bsnLuaCommandReplyVer14;
        }
    }
    ...
    final static OFBsnLuaCommandReplyVer14Funnel FUNNEL = new OFBsnLuaCommandReplyVer14Funnel();
    static class OFBsnLuaCommandReplyVer14Funnel implements Funnel<OFBsnLuaCommandReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnLuaCommandReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnLuaCommandReplyVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnLuaCommandReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnLuaCommandReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnLuaCommandReplyVer14 other = (OFBsnLuaCommandReplyVer14) obj;
