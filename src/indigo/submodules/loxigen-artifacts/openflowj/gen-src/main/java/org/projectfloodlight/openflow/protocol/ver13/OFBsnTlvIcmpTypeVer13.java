...
class OFBsnTlvIcmpTypeVer13 implements OFBsnTlvIcmpType {
...
//
    ...
    final static OFBsnTlvIcmpTypeVer13 DEFAULT = new OFBsnTlvIcmpTypeVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvIcmpType> {
        ...
        public OFBsnTlvIcmpType readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvIcmpTypeVer13 bsnTlvIcmpTypeVer13 = new OFBsnTlvIcmpTypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIcmpTypeVer13);
    ...
    final static OFBsnTlvIcmpTypeVer13Funnel FUNNEL = new OFBsnTlvIcmpTypeVer13Funnel();
    static class OFBsnTlvIcmpTypeVer13Funnel implements Funnel<OFBsnTlvIcmpTypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIcmpTypeVer13> {
        @Override
