...
class OFBsnTlvMplsControlWordVer14 implements OFBsnTlvMplsControlWord {
...
//
    ...
    final static OFBsnTlvMplsControlWordVer14 DEFAULT = new OFBsnTlvMplsControlWordVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMplsControlWord> {
        ...
        public OFBsnTlvMplsControlWord readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvMplsControlWordVer14 bsnTlvMplsControlWordVer14 = new OFBsnTlvMplsControlWordVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMplsControlWordVer14);
    ...
    final static OFBsnTlvMplsControlWordVer14Funnel FUNNEL = new OFBsnTlvMplsControlWordVer14Funnel();
    static class OFBsnTlvMplsControlWordVer14Funnel implements Funnel<OFBsnTlvMplsControlWordVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMplsControlWordVer14> {
        @Override
