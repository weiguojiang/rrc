...
class OFBsnGenericStatsReplyVer13 implements OFBsnGenericStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGenericStatsReplyVer13.class);
    // version: 1.3
...
//
    ...
    final static OFBsnGenericStatsReplyVer13 DEFAULT = new OFBsnGenericStatsReplyVer13(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGenericStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGenericStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGenericStatsReplyVer13: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGenericStatsReplyVer13: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGenericStatsReply.Builder {
        ...
        BuilderWithParent(OFBsnGenericStatsReplyVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericStatsReply> {
        ...
        public OFBsnGenericStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericStatsReplyVer13);
            return bsnGenericStatsReplyVer13;
        }
    }
    ...
    final static OFBsnGenericStatsReplyVer13Funnel FUNNEL = new OFBsnGenericStatsReplyVer13Funnel();
    static class OFBsnGenericStatsReplyVer13Funnel implements Funnel<OFBsnGenericStatsReplyVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGenericStatsReplyVer13 message, PrimitiveSink sink) {
            // fixed value property version = 4
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericStatsReplyVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnGenericStatsReplyVer13 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGenericStatsReplyVer13(");
