...
class OFOxmIpv6NdTargetMaskedVer14 implements OFOxmIpv6NdTargetMasked {
...
//
    ...
    final static OFOxmIpv6NdTargetMaskedVer14 DEFAULT = new OFOxmIpv6NdTargetMaskedVer14(
    ...
    public OFOxm<IPv6Address> getCanonical() {
        if (IPv6Address.NO_MASK.equals(mask)) {
            return new OFOxmIpv6NdTargetVer14(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6NdTargetMasked> {
        ...
        public OFOxmIpv6NdTargetMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6NdTargetMaskedVer14 oxmIpv6NdTargetMaskedVer14 = new OFOxmIpv6NdTargetMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6NdTargetMaskedVer14);
    ...
    final static OFOxmIpv6NdTargetMaskedVer14Funnel FUNNEL = new OFOxmIpv6NdTargetMaskedVer14Funnel();
    static class OFOxmIpv6NdTargetMaskedVer14Funnel implements Funnel<OFOxmIpv6NdTargetMaskedVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6NdTargetMaskedVer14> {
        @Override
