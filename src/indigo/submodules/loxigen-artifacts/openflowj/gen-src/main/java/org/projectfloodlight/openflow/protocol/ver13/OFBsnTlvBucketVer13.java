...
class OFBsnTlvBucketVer13 implements OFBsnTlvBucket {
...
//
    ...
    final static OFBsnTlvBucketVer13 DEFAULT = new OFBsnTlvBucketVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvBucket> {
        ...
        public OFBsnTlvBucket readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvBucketVer13 bsnTlvBucketVer13 = new OFBsnTlvBucketVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvBucketVer13);
    ...
    final static OFBsnTlvBucketVer13Funnel FUNNEL = new OFBsnTlvBucketVer13Funnel();
    static class OFBsnTlvBucketVer13Funnel implements Funnel<OFBsnTlvBucketVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvBucketVer13> {
        @Override
