...
class OFBsnVlanCounterClearVer13 implements OFBsnVlanCounterClear {
...
//
    ...
    final static OFBsnVlanCounterClearVer13 DEFAULT = new OFBsnVlanCounterClearVer13(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnVlanCounterClear> {
        ...
        public OFBsnVlanCounterClear readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnVlanCounterClearVer13 bsnVlanCounterClearVer13 = new OFBsnVlanCounterClearVer13(
                    xid,
                      vlanVid
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnVlanCounterClearVer13);
    ...
    final static OFBsnVlanCounterClearVer13Funnel FUNNEL = new OFBsnVlanCounterClearVer13Funnel();
    static class OFBsnVlanCounterClearVer13Funnel implements Funnel<OFBsnVlanCounterClearVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnVlanCounterClearVer13> {
        @Override
