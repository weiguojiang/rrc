...
//
    ...
    OFOxmArpSpaMaskedVer13(IPv4Address value, IPv4Address mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmArpSpaMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmArpSpaMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
...
//
    ...
    static class Writer implements OFMessageWriter<OFOxmArpSpaMaskedVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmArpSpaMaskedVer13 message) {
            // fixed value property typeLen = 0x80002d08L
