...
class OFBsnTlvRxBytesVer13 implements OFBsnTlvRxBytes {
...
//
    ...
    final static OFBsnTlvRxBytesVer13 DEFAULT = new OFBsnTlvRxBytesVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvRxBytes> {
        ...
        public OFBsnTlvRxBytes readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvRxBytesVer13 bsnTlvRxBytesVer13 = new OFBsnTlvRxBytesVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvRxBytesVer13);
    ...
    final static OFBsnTlvRxBytesVer13Funnel FUNNEL = new OFBsnTlvRxBytesVer13Funnel();
    static class OFBsnTlvRxBytesVer13Funnel implements Funnel<OFBsnTlvRxBytesVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvRxBytesVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvRxBytesVer13 message) {
            // fixed value property type = 0x47
