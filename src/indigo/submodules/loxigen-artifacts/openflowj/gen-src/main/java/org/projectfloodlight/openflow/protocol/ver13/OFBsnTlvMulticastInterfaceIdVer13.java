...
class OFBsnTlvMulticastInterfaceIdVer13 implements OFBsnTlvMulticastInterfaceId {
...
//
    ...
    final static OFBsnTlvMulticastInterfaceIdVer13 DEFAULT = new OFBsnTlvMulticastInterfaceIdVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMulticastInterfaceId> {
        ...
        public OFBsnTlvMulticastInterfaceId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvMulticastInterfaceIdVer13 bsnTlvMulticastInterfaceIdVer13 = new OFBsnTlvMulticastInterfaceIdVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMulticastInterfaceIdVer13);
    ...
    final static OFBsnTlvMulticastInterfaceIdVer13Funnel FUNNEL = new OFBsnTlvMulticastInterfaceIdVer13Funnel();
    static class OFBsnTlvMulticastInterfaceIdVer13Funnel implements Funnel<OFBsnTlvMulticastInterfaceIdVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMulticastInterfaceIdVer13> {
        @Override
