...
class OFBsnTlvIpProtoVer13 implements OFBsnTlvIpProto {
...
//
    ...
    final static OFBsnTlvIpProtoVer13 DEFAULT = new OFBsnTlvIpProtoVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvIpProto> {
        ...
        public OFBsnTlvIpProto readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvIpProtoVer13 bsnTlvIpProtoVer13 = new OFBsnTlvIpProtoVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvIpProtoVer13);
    ...
    final static OFBsnTlvIpProtoVer13Funnel FUNNEL = new OFBsnTlvIpProtoVer13Funnel();
    static class OFBsnTlvIpProtoVer13Funnel implements Funnel<OFBsnTlvIpProtoVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvIpProtoVer13> {
        @Override
