...
class OFOxmBsnInnerEthSrcMaskedVer14 implements OFOxmBsnInnerEthSrcMasked {
...
//
    ...
    final static OFOxmBsnInnerEthSrcMaskedVer14 DEFAULT = new OFOxmBsnInnerEthSrcMaskedVer14(
    ...
    public OFOxm<MacAddress> getCanonical() {
        if (MacAddress.NO_MASK.equals(mask)) {
            return new OFOxmBsnInnerEthSrcVer14(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerEthSrcMasked> {
        ...
        public OFOxmBsnInnerEthSrcMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerEthSrcMaskedVer14 oxmBsnInnerEthSrcMaskedVer14 = new OFOxmBsnInnerEthSrcMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerEthSrcMaskedVer14);
    ...
    final static OFOxmBsnInnerEthSrcMaskedVer14Funnel FUNNEL = new OFOxmBsnInnerEthSrcMaskedVer14Funnel();
    static class OFOxmBsnInnerEthSrcMaskedVer14Funnel implements Funnel<OFOxmBsnInnerEthSrcMaskedVer14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerEthSrcMaskedVer14> {
        @Override
