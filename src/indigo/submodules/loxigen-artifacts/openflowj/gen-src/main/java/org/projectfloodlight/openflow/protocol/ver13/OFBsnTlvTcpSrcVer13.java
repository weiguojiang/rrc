...
class OFBsnTlvTcpSrcVer13 implements OFBsnTlvTcpSrc {
...
//
    ...
    final static OFBsnTlvTcpSrcVer13 DEFAULT = new OFBsnTlvTcpSrcVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvTcpSrc> {
        ...
        public OFBsnTlvTcpSrc readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvTcpSrcVer13 bsnTlvTcpSrcVer13 = new OFBsnTlvTcpSrcVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvTcpSrcVer13);
    ...
    final static OFBsnTlvTcpSrcVer13Funnel FUNNEL = new OFBsnTlvTcpSrcVer13Funnel();
    static class OFBsnTlvTcpSrcVer13Funnel implements Funnel<OFBsnTlvTcpSrcVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvTcpSrcVer13> {
        @Override
