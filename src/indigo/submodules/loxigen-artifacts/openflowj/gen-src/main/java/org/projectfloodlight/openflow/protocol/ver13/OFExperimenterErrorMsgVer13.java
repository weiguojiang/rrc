...
abstract class OFExperimenterErrorMsgVer13 {
    // version: 1.3
    final static byte WIRE_VERSION = 4;
    final static int MINIMUM_LENGTH = 16;


    public final static OFExperimenterErrorMsgVer13.Reader READER = new Reader();
    ...
    static class Reader implements OFMessageReader<OFExperimenterErrorMsg> {
        ...
        public OFExperimenterErrorMsg readFrom(ByteBuf bb) throws OFParseError {
            ...
            switch(experimenter) {
               case 0x5c16c7:
                   // discriminator value 0x5c16c7L=0x5c16c7L for class OFBsnBaseErrorVer13
                   return OFBsnBaseErrorVer13.READER.readFrom(bb);
               default:
                   throw new OFParseError("Unknown value for discriminator experimenter of class OFExperimenterErrorMsgVer13: " + experimenter);
            }
        }
    }
}
