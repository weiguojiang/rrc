...
class OFBsnTlvMulticastInterfaceIdVer14 implements OFBsnTlvMulticastInterfaceId {
...
//
    ...
    final static OFBsnTlvMulticastInterfaceIdVer14 DEFAULT = new OFBsnTlvMulticastInterfaceIdVer14(
        DEFAULT_VALUE
    );
    ...
    static class BuilderWithParent implements OFBsnTlvMulticastInterfaceId.Builder {
    ...
    static class Builder implements OFBsnTlvMulticastInterfaceId.Builder {
        // OF message fields
        private boolean valueSet;
        private long value;
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMulticastInterfaceId> {
        @Override
        public OFBsnTlvMulticastInterfaceId readFrom(ByteBuf bb) throws OFParseError {
            int start = bb.readerIndex();
            // fixed value property type == 0x5f
            ...
            OFBsnTlvMulticastInterfaceIdVer14 bsnTlvMulticastInterfaceIdVer14 = new OFBsnTlvMulticastInterfaceIdVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMulticastInterfaceIdVer14);
    ...
    final static OFBsnTlvMulticastInterfaceIdVer14Funnel FUNNEL = new OFBsnTlvMulticastInterfaceIdVer14Funnel();
    static class OFBsnTlvMulticastInterfaceIdVer14Funnel implements Funnel<OFBsnTlvMulticastInterfaceIdVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnTlvMulticastInterfaceIdVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x5f
            sink.putShort((short) 0x5f);
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMulticastInterfaceIdVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvMulticastInterfaceIdVer14 message) {
            // fixed value property type = 0x5f
            bb.writeShort((short) 0x5f);
            // fixed value property length = 8
