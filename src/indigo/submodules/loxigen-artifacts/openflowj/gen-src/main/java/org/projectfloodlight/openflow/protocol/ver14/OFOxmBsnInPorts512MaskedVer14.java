...
class OFOxmBsnInPorts512MaskedVer14 implements OFOxmBsnInPorts512Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInPorts512MaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnInPorts512MaskedVer14 DEFAULT = new OFOxmBsnInPorts512MaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInPorts512MaskedVer14(OFBitMask512 value, OFBitMask512 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInPorts512MaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnInPorts512MaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnInPorts512Masked.Builder {
        final OFOxmBsnInPorts512MaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnInPorts512MaskedVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFOxmBsnInPorts512Masked build() {
                ...
                //
                return new OFOxmBsnInPorts512MaskedVer14(
                    value,
                    mask
                );
        }
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts512Masked> {
        ...
        public OFOxmBsnInPorts512Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts512MaskedVer14 oxmBsnInPorts512MaskedVer14 = new OFOxmBsnInPorts512MaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts512MaskedVer14);
            return oxmBsnInPorts512MaskedVer14;
        }
    }
    ...
    final static OFOxmBsnInPorts512MaskedVer14Funnel FUNNEL = new OFOxmBsnInPorts512MaskedVer14Funnel();
    static class OFOxmBsnInPorts512MaskedVer14Funnel implements Funnel<OFOxmBsnInPorts512MaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInPorts512MaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32780L
            sink.putInt(0x32780);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts512MaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInPorts512MaskedVer14 message) {
            // fixed value property typeLen = 0x32780L
            bb.writeInt(0x32780);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInPorts512MaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInPorts512MaskedVer14 other = (OFOxmBsnInPorts512MaskedVer14) obj;
