...
class OFOxmBsnInPorts512MaskedVer13 implements OFOxmBsnInPorts512Masked {
...
//
    ...
    final static OFOxmBsnInPorts512MaskedVer13 DEFAULT = new OFOxmBsnInPorts512MaskedVer13(
    ...
    public OFOxm<OFBitMask512> getCanonical() {
        if (OFBitMask512.NO_MASK.equals(mask)) {
            return new OFOxmBsnInPorts512Ver13(value);
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts512Masked> {
        ...
        public OFOxmBsnInPorts512Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts512MaskedVer13 oxmBsnInPorts512MaskedVer13 = new OFOxmBsnInPorts512MaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts512MaskedVer13);
    ...
    final static OFOxmBsnInPorts512MaskedVer13Funnel FUNNEL = new OFOxmBsnInPorts512MaskedVer13Funnel();
    static class OFOxmBsnInPorts512MaskedVer13Funnel implements Funnel<OFOxmBsnInPorts512MaskedVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts512MaskedVer13> {
        @Override
