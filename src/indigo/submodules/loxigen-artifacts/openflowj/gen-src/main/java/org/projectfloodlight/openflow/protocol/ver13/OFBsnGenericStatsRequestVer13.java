...
class OFBsnGenericStatsRequestVer13 implements OFBsnGenericStatsRequest {
...
//
    ...
    final static OFBsnGenericStatsRequestVer13 DEFAULT = new OFBsnGenericStatsRequestVer13(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericStatsRequest> {
        ...
        public OFBsnGenericStatsRequest readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericStatsRequestVer13);
    ...
    final static OFBsnGenericStatsRequestVer13Funnel FUNNEL = new OFBsnGenericStatsRequestVer13Funnel();
    static class OFBsnGenericStatsRequestVer13Funnel implements Funnel<OFBsnGenericStatsRequestVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericStatsRequestVer13> {
        @Override
