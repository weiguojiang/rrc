...
class OFOxmBsnInPorts512Ver12 implements OFOxmBsnInPorts512 {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInPorts512Ver12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmBsnInPorts512Ver12 DEFAULT = new OFOxmBsnInPorts512Ver12(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInPorts512Ver12(OFBitMask512 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInPorts512Ver12: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnInPorts512.Builder {
        final OFOxmBsnInPorts512Ver12 parentMessage;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts512> {
        ...
        public OFOxmBsnInPorts512 readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts512Ver12 oxmBsnInPorts512Ver12 = new OFOxmBsnInPorts512Ver12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts512Ver12);
            return oxmBsnInPorts512Ver12;
        }
    }
    ...
    final static OFOxmBsnInPorts512Ver12Funnel FUNNEL = new OFOxmBsnInPorts512Ver12Funnel();
    static class OFOxmBsnInPorts512Ver12Funnel implements Funnel<OFOxmBsnInPorts512Ver12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInPorts512Ver12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32640L
            sink.putInt(0x32640);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts512Ver12> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInPorts512Ver12 message) {
            // fixed value property typeLen = 0x32640L
            bb.writeInt(0x32640);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInPorts512Ver12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInPorts512Ver12 other = (OFOxmBsnInPorts512Ver12) obj;
