...
class OFBsnTlvEthSrcVer14 implements OFBsnTlvEthSrc {
...
//
    ...
    final static OFBsnTlvEthSrcVer14 DEFAULT = new OFBsnTlvEthSrcVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvEthSrc> {
        ...
        public OFBsnTlvEthSrc readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvEthSrcVer14 bsnTlvEthSrcVer14 = new OFBsnTlvEthSrcVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvEthSrcVer14);
    ...
    final static OFBsnTlvEthSrcVer14Funnel FUNNEL = new OFBsnTlvEthSrcVer14Funnel();
    static class OFBsnTlvEthSrcVer14Funnel implements Funnel<OFBsnTlvEthSrcVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvEthSrcVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnTlvEthSrcVer14 message) {
            // fixed value property type = 0x20
