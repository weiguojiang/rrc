...
//
    ...
    static class Reader implements OFMessageReader<OFInstructionIdBsnDisableVlanCounters> {
        @Override
        public OFInstructionIdBsnDisableVlanCounters readFrom(ByteBuf bb) throws OFParseError {
    ...
    static class Writer implements OFMessageWriter<OFInstructionIdBsnDisableVlanCountersVer13> {
        @Override
        public void write(ByteBuf bb, OFInstructionIdBsnDisableVlanCountersVer13 message) {
            // fixed value property type = 65535
