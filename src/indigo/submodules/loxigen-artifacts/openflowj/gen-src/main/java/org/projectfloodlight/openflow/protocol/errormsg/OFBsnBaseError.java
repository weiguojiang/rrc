...
public interface OFBsnBaseError extends OFObject, OFExperimenterErrorMsg {
    ...
    public interface Builder extends OFExperimenterErrorMsg.Builder {
        OFBsnBaseError build();
        OFVersion getVersion();
        OFType getType();
        long getXid();
