...
class OFBsnTlvUnknownMulticastRateVer14 implements OFBsnTlvUnknownMulticastRate {
...
//
    ...
    final static OFBsnTlvUnknownMulticastRateVer14 DEFAULT = new OFBsnTlvUnknownMulticastRateVer14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvUnknownMulticastRate> {
        ...
        public OFBsnTlvUnknownMulticastRate readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvUnknownMulticastRateVer14 bsnTlvUnknownMulticastRateVer14 = new OFBsnTlvUnknownMulticastRateVer14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvUnknownMulticastRateVer14);
    ...
    final static OFBsnTlvUnknownMulticastRateVer14Funnel FUNNEL = new OFBsnTlvUnknownMulticastRateVer14Funnel();
    static class OFBsnTlvUnknownMulticastRateVer14Funnel implements Funnel<OFBsnTlvUnknownMulticastRateVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvUnknownMulticastRateVer14> {
        @Override
