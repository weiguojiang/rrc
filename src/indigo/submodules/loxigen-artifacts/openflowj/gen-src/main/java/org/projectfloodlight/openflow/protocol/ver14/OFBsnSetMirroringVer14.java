...
class OFBsnSetMirroringVer14 implements OFBsnSetMirroring {
...
//
    ...
    final static OFBsnSetMirroringVer14 DEFAULT = new OFBsnSetMirroringVer14(
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnSetMirroring> {
        ...
        public OFBsnSetMirroring readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnSetMirroringVer14 bsnSetMirroringVer14 = new OFBsnSetMirroringVer14(
                    xid,
                      reportMirrorPorts
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnSetMirroringVer14);
    ...
    final static OFBsnSetMirroringVer14Funnel FUNNEL = new OFBsnSetMirroringVer14Funnel();
    static class OFBsnSetMirroringVer14Funnel implements Funnel<OFBsnSetMirroringVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnSetMirroringVer14> {
        @Override
