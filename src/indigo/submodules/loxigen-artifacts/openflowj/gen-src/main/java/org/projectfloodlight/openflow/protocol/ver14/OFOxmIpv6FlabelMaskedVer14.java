...
class OFOxmIpv6FlabelMaskedVer14 implements OFOxmIpv6FlabelMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmIpv6FlabelMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmIpv6FlabelMaskedVer14 DEFAULT = new OFOxmIpv6FlabelMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmIpv6FlabelMaskedVer14(IPv6FlowLabel value, IPv6FlowLabel mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmIpv6FlabelMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmIpv6FlabelMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmIpv6FlabelMasked.Builder {
        final OFOxmIpv6FlabelMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmIpv6FlabelMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmIpv6FlabelMasked> {
        ...
        public OFOxmIpv6FlabelMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmIpv6FlabelMaskedVer14 oxmIpv6FlabelMaskedVer14 = new OFOxmIpv6FlabelMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmIpv6FlabelMaskedVer14);
            return oxmIpv6FlabelMaskedVer14;
        }
    }
    ...
    final static OFOxmIpv6FlabelMaskedVer14Funnel FUNNEL = new OFOxmIpv6FlabelMaskedVer14Funnel();
    static class OFOxmIpv6FlabelMaskedVer14Funnel implements Funnel<OFOxmIpv6FlabelMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmIpv6FlabelMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x80003908L
    ...
    static class Writer implements OFMessageWriter<OFOxmIpv6FlabelMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmIpv6FlabelMaskedVer14 message) {
            // fixed value property typeLen = 0x80003908L
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmIpv6FlabelMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmIpv6FlabelMaskedVer14 other = (OFOxmIpv6FlabelMaskedVer14) obj;
