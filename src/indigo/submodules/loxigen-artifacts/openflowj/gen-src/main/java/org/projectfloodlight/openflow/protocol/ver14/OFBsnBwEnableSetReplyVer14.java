...
class OFBsnBwEnableSetReplyVer14 implements OFBsnBwEnableSetReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnBwEnableSetReplyVer14.class);
    // version: 1.4
...
//
    ...
    final static OFBsnBwEnableSetReplyVer14 DEFAULT = new OFBsnBwEnableSetReplyVer14(
        DEFAULT_XID, DEFAULT_ENABLE, DEFAULT_STATUS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnBwEnableSetReplyVer14(long xid, long enable, long status) {
        this.xid = xid;
        this.enable = enable;
        this.status = status;
    }
    ...
    static class BuilderWithParent implements OFBsnBwEnableSetReply.Builder {
        final OFBsnBwEnableSetReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnBwEnableSetReplyVer14 parentMessage) {
    ...
    public OFBsnBwEnableSetReply.Builder setStatus(long status) {
        ...
        public OFBsnBwEnableSetReply build() {
                ...
                //
                return new OFBsnBwEnableSetReplyVer14(
                    xid,
                    enable,
                    status
                );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnBwEnableSetReply> {
        ...
        public OFBsnBwEnableSetReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnBwEnableSetReplyVer14 bsnBwEnableSetReplyVer14 = new OFBsnBwEnableSetReplyVer14(
                    xid,
                      enable,
                      status
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnBwEnableSetReplyVer14);
            return bsnBwEnableSetReplyVer14;
        }
    }
    ...
    final static OFBsnBwEnableSetReplyVer14Funnel FUNNEL = new OFBsnBwEnableSetReplyVer14Funnel();
    static class OFBsnBwEnableSetReplyVer14Funnel implements Funnel<OFBsnBwEnableSetReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnBwEnableSetReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnBwEnableSetReplyVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnBwEnableSetReplyVer14 message) {
            // fixed value property version = 5
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnBwEnableSetReplyVer14(");
