...
class OFOxmBsnIngressPortGroupIdMaskedVer14 implements OFOxmBsnIngressPortGroupIdMasked {
...
//
    ...
    final static OFOxmBsnIngressPortGroupIdMaskedVer14 DEFAULT = new OFOxmBsnIngressPortGroupIdMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnIngressPortGroupIdMaskedVer14(ClassId value, ClassId mask) {
        if(value == null) {
    ...
    public OFOxm<ClassId> getCanonical() {
        if (ClassId.NO_MASK.equals(mask)) {
            return new OFOxmBsnIngressPortGroupIdVer14(value);
    ...
    static class BuilderWithParent implements OFOxmBsnIngressPortGroupIdMasked.Builder {
        ...
        BuilderWithParent(OFOxmBsnIngressPortGroupIdMaskedVer14 parentMessage) {
    ...
    public OFVersion getVersion() {
        ...
        public OFOxmBsnIngressPortGroupIdMasked build() {
                ...
                //
                return new OFOxmBsnIngressPortGroupIdMaskedVer14(
                    value,
                    mask
                );
        }
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnIngressPortGroupIdMasked> {
        ...
        public OFOxmBsnIngressPortGroupIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnIngressPortGroupIdMaskedVer14 oxmBsnIngressPortGroupIdMaskedVer14 = new OFOxmBsnIngressPortGroupIdMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnIngressPortGroupIdMaskedVer14);
            return oxmBsnIngressPortGroupIdMaskedVer14;
        }
    }
    ...
    final static OFOxmBsnIngressPortGroupIdMaskedVer14Funnel FUNNEL = new OFOxmBsnIngressPortGroupIdMaskedVer14Funnel();
    static class OFOxmBsnIngressPortGroupIdMaskedVer14Funnel implements Funnel<OFOxmBsnIngressPortGroupIdMaskedVer14> {
        ...
        @Override
        public void funnel(OFOxmBsnIngressPortGroupIdMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32908L
            sink.putInt(0x32908);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnIngressPortGroupIdMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnIngressPortGroupIdMaskedVer14 message) {
            // fixed value property typeLen = 0x32908L
            bb.writeInt(0x32908);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnIngressPortGroupIdMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnIngressPortGroupIdMaskedVer14 other = (OFOxmBsnIngressPortGroupIdMaskedVer14) obj;
