...
//
    ...
    static class Reader implements OFMessageReader<OFInstructionBsnDisableSplitHorizonCheck> {
        @Override
        public OFInstructionBsnDisableSplitHorizonCheck readFrom(ByteBuf bb) throws OFParseError {
    ...
    static class Writer implements OFMessageWriter<OFInstructionBsnDisableSplitHorizonCheckVer13> {
        @Override
        public void write(ByteBuf bb, OFInstructionBsnDisableSplitHorizonCheckVer13 message) {
            // fixed value property type = 65535
