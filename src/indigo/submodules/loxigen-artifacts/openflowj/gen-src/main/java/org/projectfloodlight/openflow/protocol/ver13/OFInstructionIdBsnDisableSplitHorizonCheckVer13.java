...
//
    ...
    static class Reader implements OFMessageReader<OFInstructionIdBsnDisableSplitHorizonCheck> {
        @Override
        public OFInstructionIdBsnDisableSplitHorizonCheck readFrom(ByteBuf bb) throws OFParseError {
    ...
    static class Writer implements OFMessageWriter<OFInstructionIdBsnDisableSplitHorizonCheckVer13> {
        @Override
        public void write(ByteBuf bb, OFInstructionIdBsnDisableSplitHorizonCheckVer13 message) {
            // fixed value property type = 65535
