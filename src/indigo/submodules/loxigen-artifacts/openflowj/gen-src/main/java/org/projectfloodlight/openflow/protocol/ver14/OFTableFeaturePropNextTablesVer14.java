...
class OFTableFeaturePropNextTablesVer14 implements OFTableFeaturePropNextTables {
    private static final Logger logger = LoggerFactory.getLogger(OFTableFeaturePropNextTablesVer14.class);
    // version: 1.4
...
//
    ...
    final static OFTableFeaturePropNextTablesVer14 DEFAULT = new OFTableFeaturePropNextTablesVer14(
        DEFAULT_NEXT_TABLE_IDS
    );

    // package private constructor - used by readers, builders, and factory
    OFTableFeaturePropNextTablesVer14(List<U8> nextTableIds) {
        if(nextTableIds == null) {
            throw new NullPointerException("OFTableFeaturePropNextTablesVer14: property nextTableIds cannot be null");
        }
    ...
    static class BuilderWithParent implements OFTableFeaturePropNextTables.Builder {
        final OFTableFeaturePropNextTablesVer14 parentMessage;

        // OF message fields
        private boolean nextTableIdsSet;
        private List<U8> nextTableIds;

        BuilderWithParent(OFTableFeaturePropNextTablesVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturePropNextTables> {
        ...
        public OFTableFeaturePropNextTables readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFTableFeaturePropNextTablesVer14 tableFeaturePropNextTablesVer14 = new OFTableFeaturePropNextTablesVer14(
                    nextTableIds
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", tableFeaturePropNextTablesVer14);
            return tableFeaturePropNextTablesVer14;
        }
    }
    ...
    final static OFTableFeaturePropNextTablesVer14Funnel FUNNEL = new OFTableFeaturePropNextTablesVer14Funnel();
    static class OFTableFeaturePropNextTablesVer14Funnel implements Funnel<OFTableFeaturePropNextTablesVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFTableFeaturePropNextTablesVer14 message, PrimitiveSink sink) {
            // fixed value property type = 0x2
    ...
    static class Writer implements OFMessageWriter<OFTableFeaturePropNextTablesVer14> {
        @Override
        public void write(ByteBuf bb, OFTableFeaturePropNextTablesVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFTableFeaturePropNextTablesVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFTableFeaturePropNextTablesVer14 other = (OFTableFeaturePropNextTablesVer14) obj;
