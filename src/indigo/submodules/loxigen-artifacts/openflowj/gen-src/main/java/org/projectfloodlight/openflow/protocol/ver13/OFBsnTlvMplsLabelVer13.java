...
class OFBsnTlvMplsLabelVer13 implements OFBsnTlvMplsLabel {
...
//
    ...
    final static OFBsnTlvMplsLabelVer13 DEFAULT = new OFBsnTlvMplsLabelVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnTlvMplsLabel> {
        ...
        public OFBsnTlvMplsLabel readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnTlvMplsLabelVer13 bsnTlvMplsLabelVer13 = new OFBsnTlvMplsLabelVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnTlvMplsLabelVer13);
    ...
    final static OFBsnTlvMplsLabelVer13Funnel FUNNEL = new OFBsnTlvMplsLabelVer13Funnel();
    static class OFBsnTlvMplsLabelVer13Funnel implements Funnel<OFBsnTlvMplsLabelVer13> {
    ...
    static class Writer implements OFMessageWriter<OFBsnTlvMplsLabelVer13> {
        @Override
