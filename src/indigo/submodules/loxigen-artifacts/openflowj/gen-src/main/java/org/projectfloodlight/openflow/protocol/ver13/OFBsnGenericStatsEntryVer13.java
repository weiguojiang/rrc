...
class OFBsnGenericStatsEntryVer13 implements OFBsnGenericStatsEntry {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGenericStatsEntryVer13.class);
    // version: 1.3
...
//
    ...
    final static OFBsnGenericStatsEntryVer13 DEFAULT = new OFBsnGenericStatsEntryVer13(
        DEFAULT_TLVS
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGenericStatsEntryVer13(List<OFBsnTlv> tlvs) {
        if(tlvs == null) {
            throw new NullPointerException("OFBsnGenericStatsEntryVer13: property tlvs cannot be null");
        }
        this.tlvs = tlvs;
    }
    ...
    static class BuilderWithParent implements OFBsnGenericStatsEntry.Builder {
        final OFBsnGenericStatsEntryVer13 parentMessage;

        // OF message fields
        private boolean tlvsSet;
        private List<OFBsnTlv> tlvs;

        BuilderWithParent(OFBsnGenericStatsEntryVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericStatsEntry> {
        ...
        public OFBsnGenericStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericStatsEntryVer13);
            return bsnGenericStatsEntryVer13;
        }
    }
    ...
    final static OFBsnGenericStatsEntryVer13Funnel FUNNEL = new OFBsnGenericStatsEntryVer13Funnel();
    static class OFBsnGenericStatsEntryVer13Funnel implements Funnel<OFBsnGenericStatsEntryVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGenericStatsEntryVer13 message, PrimitiveSink sink) {
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericStatsEntryVer13> {
        @Override
        public void write(ByteBuf bb, OFBsnGenericStatsEntryVer13 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGenericStatsEntryVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGenericStatsEntryVer13 other = (OFBsnGenericStatsEntryVer13) obj;
