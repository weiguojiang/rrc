...
class OFOxmBsnIngressPortGroupIdVer12 implements OFOxmBsnIngressPortGroupId {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnIngressPortGroupIdVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmBsnIngressPortGroupIdVer12 DEFAULT = new OFOxmBsnIngressPortGroupIdVer12(
        DEFAULT_VALUE
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnIngressPortGroupIdVer12(ClassId value) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnIngressPortGroupIdVer12: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnIngressPortGroupId.Builder {
        final OFOxmBsnIngressPortGroupIdVer12 parentMessage;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnIngressPortGroupId> {
        ...
        public OFOxmBsnIngressPortGroupId readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnIngressPortGroupIdVer12 oxmBsnIngressPortGroupIdVer12 = new OFOxmBsnIngressPortGroupIdVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnIngressPortGroupIdVer12);
            return oxmBsnIngressPortGroupIdVer12;
        }
    }
    ...
    final static OFOxmBsnIngressPortGroupIdVer12Funnel FUNNEL = new OFOxmBsnIngressPortGroupIdVer12Funnel();
    static class OFOxmBsnIngressPortGroupIdVer12Funnel implements Funnel<OFOxmBsnIngressPortGroupIdVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnIngressPortGroupIdVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32804L
            sink.putInt(0x32804);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnIngressPortGroupIdVer12> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnIngressPortGroupIdVer12 message) {
            // fixed value property typeLen = 0x32804L
            bb.writeInt(0x32804);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnIngressPortGroupIdVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnIngressPortGroupIdVer12 other = (OFOxmBsnIngressPortGroupIdVer12) obj;
