...
class OFBsnGenericStatsReplyVer14 implements OFBsnGenericStatsReply {
    private static final Logger logger = LoggerFactory.getLogger(OFBsnGenericStatsReplyVer14.class);
    // version: 1.4
    ...
    final static int MINIMUM_LENGTH = 24;
        ...
        private final static List<OFBsnGenericStatsEntry> DEFAULT_ENTRIES = ImmutableList.<OFBsnGenericStatsEntry>of();

    // OF message fields
    private final long xid;
    private final Set<OFStatsReplyFlags> flags;
    private final List<OFBsnGenericStatsEntry> entries;
//
    // Immutable default instance
    final static OFBsnGenericStatsReplyVer14 DEFAULT = new OFBsnGenericStatsReplyVer14(
        DEFAULT_XID, DEFAULT_FLAGS, DEFAULT_ENTRIES
    );

    // package private constructor - used by readers, builders, and factory
    OFBsnGenericStatsReplyVer14(long xid, Set<OFStatsReplyFlags> flags, List<OFBsnGenericStatsEntry> entries) {
        if(flags == null) {
            throw new NullPointerException("OFBsnGenericStatsReplyVer14: property flags cannot be null");
        }
        if(entries == null) {
            throw new NullPointerException("OFBsnGenericStatsReplyVer14: property entries cannot be null");
        }
        this.xid = xid;
        this.flags = flags;
    ...
    static class BuilderWithParent implements OFBsnGenericStatsReply.Builder {
        final OFBsnGenericStatsReplyVer14 parentMessage;
        ...
        BuilderWithParent(OFBsnGenericStatsReplyVer14 parentMessage) {
    ...
    public OFBsnGenericStatsReply.Builder setEntries(List<OFBsnGenericStatsEntry> entries) {
        ...
        public OFBsnGenericStatsReply build() {
                ...
                //
                return new OFBsnGenericStatsReplyVer14(
                    xid,
                    flags,
                    entries
                );
    ...
    static class Builder implements OFBsnGenericStatsReply.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean flagsSet;
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericStatsReply> {
        ...
        public OFBsnGenericStatsReply readFrom(ByteBuf bb) throws OFParseError {
            ...
            List<OFBsnGenericStatsEntry> entries = ChannelUtils.readList(bb, length - (bb.readerIndex() - start), OFBsnGenericStatsEntryVer14.READER);

            OFBsnGenericStatsReplyVer14 bsnGenericStatsReplyVer14 = new OFBsnGenericStatsReplyVer14(
                    xid,
                      flags,
                      entries
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericStatsReplyVer14);
            return bsnGenericStatsReplyVer14;
        }
    }
    ...
    final static OFBsnGenericStatsReplyVer14Funnel FUNNEL = new OFBsnGenericStatsReplyVer14Funnel();
    static class OFBsnGenericStatsReplyVer14Funnel implements Funnel<OFBsnGenericStatsReplyVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFBsnGenericStatsReplyVer14 message, PrimitiveSink sink) {
            // fixed value property version = 5
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericStatsReplyVer14> {
        @Override
        public void write(ByteBuf bb, OFBsnGenericStatsReplyVer14 message) {
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFBsnGenericStatsReplyVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFBsnGenericStatsReplyVer14 other = (OFBsnGenericStatsReplyVer14) obj;
