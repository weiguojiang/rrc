...
class OFOxmBsnInnerEthSrcVer13 implements OFOxmBsnInnerEthSrc {
...
//
    ...
    final static OFOxmBsnInnerEthSrcVer13 DEFAULT = new OFOxmBsnInnerEthSrcVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInnerEthSrc> {
        ...
        public OFOxmBsnInnerEthSrc readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInnerEthSrcVer13 oxmBsnInnerEthSrcVer13 = new OFOxmBsnInnerEthSrcVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInnerEthSrcVer13);
    ...
    final static OFOxmBsnInnerEthSrcVer13Funnel FUNNEL = new OFOxmBsnInnerEthSrcVer13Funnel();
    static class OFOxmBsnInnerEthSrcVer13Funnel implements Funnel<OFOxmBsnInnerEthSrcVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInnerEthSrcVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInnerEthSrcVer13 message) {
            // fixed value property typeLen = 0x32e06L
            bb.writeInt(0x32e06);
