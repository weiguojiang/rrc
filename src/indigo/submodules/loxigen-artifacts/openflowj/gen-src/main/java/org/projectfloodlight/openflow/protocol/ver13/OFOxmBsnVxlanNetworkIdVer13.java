...
class OFOxmBsnVxlanNetworkIdVer13 implements OFOxmBsnVxlanNetworkId {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnVxlanNetworkIdVer13.class);
    // version: 1.3
...
//
    ...
    static class BuilderWithParent implements OFOxmBsnVxlanNetworkId.Builder {
        final OFOxmBsnVxlanNetworkIdVer13 parentMessage;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnVxlanNetworkId> {
        ...
        public OFOxmBsnVxlanNetworkId readFrom(ByteBuf bb) throws OFParseError {
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnVxlanNetworkIdVer13);
            return oxmBsnVxlanNetworkIdVer13;
        }
    }
    ...
    final static OFOxmBsnVxlanNetworkIdVer13Funnel FUNNEL = new OFOxmBsnVxlanNetworkIdVer13Funnel();
    static class OFOxmBsnVxlanNetworkIdVer13Funnel implements Funnel<OFOxmBsnVxlanNetworkIdVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnVxlanNetworkIdVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x32a04L
            sink.putInt(0x32a04);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnVxlanNetworkIdVer13> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnVxlanNetworkIdVer13 message) {
            // fixed value property typeLen = 0x32a04L
            bb.writeInt(0x32a04);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnVxlanNetworkIdVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnVxlanNetworkIdVer13 other = (OFOxmBsnVxlanNetworkIdVer13) obj;
