...
class OFOxmBsnLagIdMaskedVer14 implements OFOxmBsnLagIdMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnLagIdMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnLagIdMaskedVer14 DEFAULT = new OFOxmBsnLagIdMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnLagIdMaskedVer14(LagId value, LagId mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnLagIdMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnLagIdMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnLagIdMasked.Builder {
        final OFOxmBsnLagIdMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnLagIdMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnLagIdMasked> {
        ...
        public OFOxmBsnLagIdMasked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnLagIdMaskedVer14 oxmBsnLagIdMaskedVer14 = new OFOxmBsnLagIdMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnLagIdMaskedVer14);
            return oxmBsnLagIdMaskedVer14;
        }
    }
    ...
    final static OFOxmBsnLagIdMaskedVer14Funnel FUNNEL = new OFOxmBsnLagIdMaskedVer14Funnel();
    static class OFOxmBsnLagIdMaskedVer14Funnel implements Funnel<OFOxmBsnLagIdMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnLagIdMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x30308L
            sink.putInt(0x30308);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnLagIdMaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnLagIdMaskedVer14 message) {
            // fixed value property typeLen = 0x30308L
            bb.writeInt(0x30308);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnLagIdMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnLagIdMaskedVer14 other = (OFOxmBsnLagIdMaskedVer14) obj;
