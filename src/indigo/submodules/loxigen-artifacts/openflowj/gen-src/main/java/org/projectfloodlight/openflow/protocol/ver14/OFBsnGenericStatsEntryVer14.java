...
class OFBsnGenericStatsEntryVer14 implements OFBsnGenericStatsEntry {
...
//
    ...
    final static OFBsnGenericStatsEntryVer14 DEFAULT = new OFBsnGenericStatsEntryVer14(
        DEFAULT_TLVS
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFBsnGenericStatsEntry> {
        ...
        public OFBsnGenericStatsEntry readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFBsnGenericStatsEntryVer14 bsnGenericStatsEntryVer14 = new OFBsnGenericStatsEntryVer14(
                    tlvs
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", bsnGenericStatsEntryVer14);
    ...
    final static OFBsnGenericStatsEntryVer14Funnel FUNNEL = new OFBsnGenericStatsEntryVer14Funnel();
    static class OFBsnGenericStatsEntryVer14Funnel implements Funnel<OFBsnGenericStatsEntryVer14> {
    ...
    static class Writer implements OFMessageWriter<OFBsnGenericStatsEntryVer14> {
        @Override
