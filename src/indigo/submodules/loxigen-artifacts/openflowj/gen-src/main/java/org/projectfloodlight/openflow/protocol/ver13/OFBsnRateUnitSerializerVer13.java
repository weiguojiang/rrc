...
public class OFBsnRateUnitSerializerVer13 {
    ...
    public static OFBsnRateUnit ofWireValue(byte val) {
        switch(val) {
            ...
            default:
                throw new IllegalArgumentException("Illegal wire value for type OFBsnRateUnit in version 1.3: " + val);
        }
    }
    ...
    public static byte toWireValue(OFBsnRateUnit e) {
        switch(e) {
            ...
            default:
                throw new IllegalArgumentException("Illegal enum value for type OFBsnRateUnit in version 1.3: " + e);
        }
    }
