...
class OFOxmBsnInPorts128MaskedVer14 implements OFOxmBsnInPorts128Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmBsnInPorts128MaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmBsnInPorts128MaskedVer14 DEFAULT = new OFOxmBsnInPorts128MaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmBsnInPorts128MaskedVer14(OFBitMask128 value, OFBitMask128 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmBsnInPorts128MaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmBsnInPorts128MaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmBsnInPorts128Masked.Builder {
        final OFOxmBsnInPorts128MaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmBsnInPorts128MaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmBsnInPorts128Masked> {
        ...
        public OFOxmBsnInPorts128Masked readFrom(ByteBuf bb) throws OFParseError {
            ...
            OFOxmBsnInPorts128MaskedVer14 oxmBsnInPorts128MaskedVer14 = new OFOxmBsnInPorts128MaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmBsnInPorts128MaskedVer14);
            return oxmBsnInPorts128MaskedVer14;
        }
    }
    ...
    final static OFOxmBsnInPorts128MaskedVer14Funnel FUNNEL = new OFOxmBsnInPorts128MaskedVer14Funnel();
    static class OFOxmBsnInPorts128MaskedVer14Funnel implements Funnel<OFOxmBsnInPorts128MaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmBsnInPorts128MaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x30120L
            sink.putInt(0x30120);
    ...
    static class Writer implements OFMessageWriter<OFOxmBsnInPorts128MaskedVer14> {
        @Override
        public void write(ByteBuf bb, OFOxmBsnInPorts128MaskedVer14 message) {
            // fixed value property typeLen = 0x30120L
            bb.writeInt(0x30120);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmBsnInPorts128MaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmBsnInPorts128MaskedVer14 other = (OFOxmBsnInPorts128MaskedVer14) obj;
