...
int
of_list_action_first(of_list_action_t *list, of_object_t *obj)
{
    int rv;

    of_action_init(obj, list->version, -1, 1);

    if ((rv = of_list_first(list, obj)) < 0) {
        return rv;
    }

    of_action_wire_object_id_get(obj, &obj->object_id);
...
int
of_list_action_next(of_list_action_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_action_append_bind(of_list_action_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_action list.
 *
...
int
of_list_action_append(of_list_action_t *list, of_object_t *obj)
{
...
void
of_list_action_init(of_object_t *obj,
