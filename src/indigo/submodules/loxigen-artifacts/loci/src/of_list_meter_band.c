...
int
of_list_meter_band_first(of_list_meter_band_t *list, of_object_t *obj)
{
    int rv;
    ...
    of_meter_band_wire_object_id_get(obj, &obj->object_id);
...
int
of_list_meter_band_next(of_list_meter_band_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_meter_band_append_bind(of_list_meter_band_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_meter_band list.
 *
...
int
of_list_meter_band_append(of_list_meter_band_t *list, of_object_t *obj)
{
