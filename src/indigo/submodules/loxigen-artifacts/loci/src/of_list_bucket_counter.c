...
int
of_list_bucket_counter_first(of_list_bucket_counter_t *list, of_object_t *obj)
{
    int rv;

    of_bucket_counter_init(obj, list->version, -1, 1);
...
int
of_list_bucket_counter_next(of_list_bucket_counter_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_bucket_counter_append_bind(of_list_bucket_counter_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_bucket_counter list.
 *
...
int
of_list_bucket_counter_append(of_list_bucket_counter_t *list, of_object_t *obj)
{
...
void
of_list_bucket_counter_init(of_object_t *obj,
