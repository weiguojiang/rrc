...
int
of_list_oxm_first(of_list_oxm_t *list, of_object_t *obj)
{
    int rv;

    of_oxm_init(obj, list->version, -1, 1);

    if ((rv = of_list_first(list, obj)) < 0) {
        return rv;
    }

    of_oxm_wire_object_id_get(obj, &obj->object_id);

    of_oxm_wire_length_get(obj, &obj->length);
...
int
of_list_oxm_next(of_list_oxm_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_oxm_append_bind(of_list_oxm_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_oxm list.
 *
...
int
of_list_oxm_append(of_list_oxm_t *list, of_object_t *obj)
{
...
void
of_list_oxm_init(of_object_t *obj,
