...
int
of_list_port_desc_first(of_list_port_desc_t *list, of_object_t *obj)
{
    int rv;

    of_port_desc_init(obj, list->version, -1, 1);
...
int
of_list_port_desc_next(of_list_port_desc_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_port_desc_append_bind(of_list_port_desc_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_port_desc list.
 *
...
int
of_list_port_desc_append(of_list_port_desc_t *list, of_object_t *obj)
{
...
void
of_list_port_desc_init(of_object_t *obj,
