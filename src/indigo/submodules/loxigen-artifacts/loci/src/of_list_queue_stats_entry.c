...
int
of_list_queue_stats_entry_first(of_list_queue_stats_entry_t *list, of_object_t *obj)
{
    int rv;

    of_queue_stats_entry_init(obj, list->version, -1, 1);
    ...
    of_queue_stats_entry_wire_length_get(obj, &obj->length);
...
int
of_list_queue_stats_entry_next(of_list_queue_stats_entry_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_queue_stats_entry_append_bind(of_list_queue_stats_entry_t *list, of_object_t *obj)
{
...
int
of_list_queue_stats_entry_append(of_list_queue_stats_entry_t *list, of_object_t *obj)
{
...
void
of_list_queue_stats_entry_init(of_object_t *obj,
