...
int
of_list_instruction_next(of_list_instruction_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_instruction_append_bind(of_list_instruction_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_instruction list.
 *
...
int
of_list_instruction_append(of_list_instruction_t *list, of_object_t *obj)
{
...
void
of_list_instruction_init(of_object_t *obj,
