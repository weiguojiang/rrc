...
int
of_list_group_desc_stats_entry_first(of_list_group_desc_stats_entry_t *list, of_object_t *obj)
{
    int rv;

    of_group_desc_stats_entry_init(obj, list->version, -1, 1);
...
int
of_list_group_desc_stats_entry_next(of_list_group_desc_stats_entry_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_group_desc_stats_entry_append_bind(of_list_group_desc_stats_entry_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_group_desc_stats_entry list.
 *
...
int
of_list_group_desc_stats_entry_append(of_list_group_desc_stats_entry_t *list, of_object_t *obj)
{
...
void
of_list_group_desc_stats_entry_init(of_object_t *obj,
