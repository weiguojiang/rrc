...
int
of_list_uint8_first(of_list_uint8_t *list, of_object_t *obj)
{
    int rv;

    of_uint8_init(obj, list->version, -1, 1);
...
int
of_list_uint8_next(of_list_uint8_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_uint8_append_bind(of_list_uint8_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_uint8 list.
 *
...
int
of_list_uint8_append(of_list_uint8_t *list, of_object_t *obj)
{
...
void
of_list_uint8_init(of_object_t *obj,
