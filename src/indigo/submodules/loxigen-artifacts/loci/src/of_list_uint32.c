...
int
of_list_uint32_next(of_list_uint32_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_uint32_append_bind(of_list_uint32_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_uint32 list.
 *
...
int
of_list_uint32_append(of_list_uint32_t *list, of_object_t *obj)
{
