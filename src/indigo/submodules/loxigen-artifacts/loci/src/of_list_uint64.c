...
int
of_list_uint64_first(of_list_uint64_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_uint64_next(of_list_uint64_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_uint64_append_bind(of_list_uint64_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_uint64 list.
 *
...
int
of_list_uint64_append(of_list_uint64_t *list, of_object_t *obj)
{
