...
int
of_list_packet_queue_first(of_list_packet_queue_t *list, of_object_t *obj)
{
    int rv;
    ...
    of_packet_queue_wire_length_get(obj, &obj->length);
...
int
of_list_packet_queue_next(of_list_packet_queue_t *list, of_object_t *obj)
{
    int rv;
...
int
of_list_packet_queue_append_bind(of_list_packet_queue_t *list, of_object_t *obj)
{
    return of_list_append_bind(list, obj);
}

/**
 * Append an object to a of_list_packet_queue list.
 *
...
int
of_list_packet_queue_append(of_list_packet_queue_t *list, of_object_t *obj)
{
