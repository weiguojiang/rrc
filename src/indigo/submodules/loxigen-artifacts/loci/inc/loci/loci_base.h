...
typedef enum of_object_id_e {
    ...
    OF_BSN_GENERIC_STATS_REPLY = 37,
    OF_BSN_GENERIC_STATS_REQUEST = 38,
    OF_BSN_GENTABLE_BUCKET_STATS_REPLY = 39,
    OF_BSN_GENTABLE_BUCKET_STATS_REQUEST = 40,
    OF_BSN_GENTABLE_CLEAR_REPLY = 41,
    OF_BSN_GENTABLE_CLEAR_REQUEST = 42,
    OF_BSN_GENTABLE_DESC_STATS_REPLY = 43,
    OF_BSN_GENTABLE_DESC_STATS_REQUEST = 44,
    OF_BSN_GENTABLE_ENTRY_ADD = 45,
    OF_BSN_GENTABLE_ENTRY_DELETE = 46,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REPLY = 47,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_REQUEST = 48,
    OF_BSN_GENTABLE_ENTRY_STATS_REPLY = 49,
    OF_BSN_GENTABLE_ENTRY_STATS_REQUEST = 50,
    OF_BSN_GENTABLE_SET_BUCKETS_SIZE = 51,
    OF_BSN_GENTABLE_STATS_REPLY = 52,
    OF_BSN_GENTABLE_STATS_REQUEST = 53,
    OF_BSN_GET_INTERFACES_REPLY = 54,
    OF_BSN_GET_INTERFACES_REQUEST = 55,
    OF_BSN_GET_IP_MASK_REPLY = 56,
    OF_BSN_GET_IP_MASK_REQUEST = 57,
    OF_BSN_GET_L2_TABLE_REPLY = 58,
    OF_BSN_GET_L2_TABLE_REQUEST = 59,
    OF_BSN_GET_MIRRORING_REPLY = 60,
    OF_BSN_GET_MIRRORING_REQUEST = 61,
    OF_BSN_GET_SWITCH_PIPELINE_REPLY = 62,
    OF_BSN_GET_SWITCH_PIPELINE_REQUEST = 63,
    OF_BSN_HEADER = 64,
    OF_BSN_HYBRID_GET_REPLY = 65,
    OF_BSN_HYBRID_GET_REQUEST = 66,
    OF_BSN_IMAGE_DESC_STATS_REPLY = 67,
    OF_BSN_IMAGE_DESC_STATS_REQUEST = 68,
    OF_BSN_LACP_CONVERGENCE_NOTIF = 69,
    OF_BSN_LACP_STATS_REPLY = 70,
    OF_BSN_LACP_STATS_REQUEST = 71,
    OF_BSN_LOG = 72,
    OF_BSN_LUA_COMMAND_REPLY = 73,
    OF_BSN_LUA_COMMAND_REQUEST = 74,
    OF_BSN_LUA_NOTIFICATION = 75,
    OF_BSN_LUA_UPLOAD = 76,
    OF_BSN_PDU_RX_REPLY = 77,
    OF_BSN_PDU_RX_REQUEST = 78,
    OF_BSN_PDU_RX_TIMEOUT = 79,
    OF_BSN_PDU_TX_REPLY = 80,
    OF_BSN_PDU_TX_REQUEST = 81,
    OF_BSN_PORT_COUNTER_STATS_REPLY = 82,
    OF_BSN_PORT_COUNTER_STATS_REQUEST = 83,
    OF_BSN_ROLE_STATUS = 84,
    OF_BSN_SET_AUX_CXNS_REPLY = 85,
    OF_BSN_SET_AUX_CXNS_REQUEST = 86,
    OF_BSN_SET_IP_MASK = 87,
    OF_BSN_SET_L2_TABLE_REPLY = 88,
    OF_BSN_SET_L2_TABLE_REQUEST = 89,
    OF_BSN_SET_LACP_REPLY = 90,
    OF_BSN_SET_LACP_REQUEST = 91,
    OF_BSN_SET_MIRRORING = 92,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 93,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 94,
    OF_BSN_SET_SWITCH_PIPELINE_REPLY = 95,
    OF_BSN_SET_SWITCH_PIPELINE_REQUEST = 96,
    OF_BSN_SHELL_COMMAND = 97,
    OF_BSN_SHELL_OUTPUT = 98,
    OF_BSN_SHELL_STATUS = 99,
    OF_BSN_STATS_REPLY = 100,
    OF_BSN_STATS_REQUEST = 101,
    OF_BSN_SWITCH_PIPELINE_STATS_REPLY = 102,
    OF_BSN_SWITCH_PIPELINE_STATS_REQUEST = 103,
    OF_BSN_TABLE_CHECKSUM_STATS_REPLY = 104,
    OF_BSN_TABLE_CHECKSUM_STATS_REQUEST = 105,
    OF_BSN_TABLE_SET_BUCKETS_SIZE = 106,
    OF_BSN_TAKEOVER = 107,
    OF_BSN_TIME_REPLY = 108,
    OF_BSN_TIME_REQUEST = 109,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 110,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 111,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 112,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 113,
    OF_BSN_VLAN_COUNTER_CLEAR = 114,
    OF_BSN_VLAN_COUNTER_STATS_REPLY = 115,
    OF_BSN_VLAN_COUNTER_STATS_REQUEST = 116,
    OF_BSN_VRF_COUNTER_STATS_REPLY = 117,
    OF_BSN_VRF_COUNTER_STATS_REQUEST = 118,
    OF_BUNDLE_ADD_MSG = 119,
    OF_BUNDLE_CTRL_MSG = 120,
    OF_BUNDLE_FAILED_ERROR_MSG = 121,
    OF_DESC_STATS_REPLY = 122,
    OF_DESC_STATS_REQUEST = 123,
    OF_ECHO_REPLY = 124,
    OF_ECHO_REQUEST = 125,
    OF_ERROR_MSG = 126,
    OF_EXPERIMENTER = 127,
    OF_EXPERIMENTER_ERROR_MSG = 128,
    OF_EXPERIMENTER_STATS_REPLY = 129,
    OF_EXPERIMENTER_STATS_REQUEST = 130,
    OF_FEATURES_REPLY = 131,
    OF_FEATURES_REQUEST = 132,
    OF_FLOW_ADD = 133,
    OF_FLOW_DELETE = 134,
    OF_FLOW_DELETE_STRICT = 135,
    OF_FLOW_MOD = 136,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 137,
    OF_FLOW_MODIFY = 138,
    OF_FLOW_MODIFY_STRICT = 139,
    OF_FLOW_MONITOR_FAILED_ERROR_MSG = 140,
    OF_FLOW_REMOVED = 141,
    OF_FLOW_STATS_REPLY = 142,
    OF_FLOW_STATS_REQUEST = 143,
    OF_GET_CONFIG_REPLY = 144,
    OF_GET_CONFIG_REQUEST = 145,
    OF_GROUP_ADD = 146,
    OF_GROUP_DELETE = 147,
    OF_GROUP_DESC_STATS_REPLY = 148,
    OF_GROUP_DESC_STATS_REQUEST = 149,
    OF_GROUP_FEATURES_STATS_REPLY = 150,
    OF_GROUP_FEATURES_STATS_REQUEST = 151,
    OF_GROUP_MOD = 152,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 153,
    OF_GROUP_MODIFY = 154,
    OF_GROUP_STATS_REPLY = 155,
    OF_GROUP_STATS_REQUEST = 156,
    OF_HEADER = 157,
    OF_HELLO = 158,
    OF_HELLO_FAILED_ERROR_MSG = 159,
    OF_METER_CONFIG_STATS_REPLY = 160,
    OF_METER_CONFIG_STATS_REQUEST = 161,
    OF_METER_FEATURES_STATS_REPLY = 162,
    OF_METER_FEATURES_STATS_REQUEST = 163,
    OF_METER_MOD = 164,
    OF_METER_MOD_FAILED_ERROR_MSG = 165,
    OF_METER_STATS_REPLY = 166,
    OF_METER_STATS_REQUEST = 167,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 168,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 169,
    OF_NICIRA_HEADER = 170,
    OF_PACKET_IN = 171,
    OF_PACKET_OUT = 172,
    OF_PORT_DESC_STATS_REPLY = 173,
    OF_PORT_DESC_STATS_REQUEST = 174,
    OF_PORT_MOD = 175,
    OF_PORT_MOD_FAILED_ERROR_MSG = 176,
    OF_PORT_STATS_REPLY = 177,
    OF_PORT_STATS_REQUEST = 178,
    OF_PORT_STATUS = 179,
    OF_QUEUE_DESC_STATS_REPLY = 180,
    OF_QUEUE_DESC_STATS_REQUEST = 181,
    OF_QUEUE_GET_CONFIG_REPLY = 182,
    OF_QUEUE_GET_CONFIG_REQUEST = 183,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 184,
    OF_QUEUE_STATS_REPLY = 185,
    OF_QUEUE_STATS_REQUEST = 186,
    OF_REQUESTFORWARD = 187,
    OF_ROLE_REPLY = 188,
    OF_ROLE_REQUEST = 189,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 190,
    OF_ROLE_STATUS = 191,
    OF_SET_CONFIG = 192,
    OF_STATS_REPLY = 193,
    OF_STATS_REQUEST = 194,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 195,
    OF_TABLE_DESC_STATS_REPLY = 196,
    OF_TABLE_DESC_STATS_REQUEST = 197,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 198,
    OF_TABLE_FEATURES_STATS_REPLY = 199,
    OF_TABLE_FEATURES_STATS_REQUEST = 200,
    OF_TABLE_MOD = 201,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 202,
    OF_TABLE_STATS_REPLY = 203,
    OF_TABLE_STATS_REQUEST = 204,
    OF_TABLE_STATUS = 205,

    /* Non-message objects */
    OF_ACTION = 206,
    OF_ACTION_BSN = 207,
    OF_ACTION_BSN_CHECKSUM = 208,
    OF_ACTION_BSN_GENTABLE = 209,
    OF_ACTION_BSN_MIRROR = 210,
    OF_ACTION_BSN_SET_TUNNEL_DST = 211,
    OF_ACTION_COPY_TTL_IN = 212,
    OF_ACTION_COPY_TTL_OUT = 213,
    OF_ACTION_DEC_MPLS_TTL = 214,
    OF_ACTION_DEC_NW_TTL = 215,
    OF_ACTION_ENQUEUE = 216,
    OF_ACTION_EXPERIMENTER = 217,
    OF_ACTION_GROUP = 218,
    OF_ACTION_ID = 219,
    OF_ACTION_ID_BSN = 220,
    OF_ACTION_ID_BSN_CHECKSUM = 221,
    OF_ACTION_ID_BSN_GENTABLE = 222,
    OF_ACTION_ID_BSN_MIRROR = 223,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 224,
    OF_ACTION_ID_COPY_TTL_IN = 225,
    OF_ACTION_ID_COPY_TTL_OUT = 226,
    OF_ACTION_ID_DEC_MPLS_TTL = 227,
    OF_ACTION_ID_DEC_NW_TTL = 228,
    OF_ACTION_ID_EXPERIMENTER = 229,
    OF_ACTION_ID_GROUP = 230,
    OF_ACTION_ID_NICIRA = 231,
    OF_ACTION_ID_NICIRA_DEC_TTL = 232,
    OF_ACTION_ID_OUTPUT = 233,
    OF_ACTION_ID_POP_MPLS = 234,
    OF_ACTION_ID_POP_PBB = 235,
    OF_ACTION_ID_POP_VLAN = 236,
    OF_ACTION_ID_PUSH_MPLS = 237,
    OF_ACTION_ID_PUSH_PBB = 238,
    OF_ACTION_ID_PUSH_VLAN = 239,
    OF_ACTION_ID_SET_FIELD = 240,
    OF_ACTION_ID_SET_MPLS_TTL = 241,
    OF_ACTION_ID_SET_NW_TTL = 242,
    OF_ACTION_ID_SET_QUEUE = 243,
    OF_ACTION_NICIRA = 244,
    OF_ACTION_NICIRA_DEC_TTL = 245,
    OF_ACTION_OUTPUT = 246,
    OF_ACTION_POP_MPLS = 247,
    OF_ACTION_POP_PBB = 248,
    OF_ACTION_POP_VLAN = 249,
    OF_ACTION_PUSH_MPLS = 250,
    OF_ACTION_PUSH_PBB = 251,
    OF_ACTION_PUSH_VLAN = 252,
    OF_ACTION_SET_DL_DST = 253,
    OF_ACTION_SET_DL_SRC = 254,
    OF_ACTION_SET_FIELD = 255,
    OF_ACTION_SET_MPLS_LABEL = 256,
    OF_ACTION_SET_MPLS_TC = 257,
    OF_ACTION_SET_MPLS_TTL = 258,
    OF_ACTION_SET_NW_DST = 259,
    OF_ACTION_SET_NW_ECN = 260,
    OF_ACTION_SET_NW_SRC = 261,
    OF_ACTION_SET_NW_TOS = 262,
    OF_ACTION_SET_NW_TTL = 263,
    OF_ACTION_SET_QUEUE = 264,
    OF_ACTION_SET_TP_DST = 265,
    OF_ACTION_SET_TP_SRC = 266,
    OF_ACTION_SET_VLAN_PCP = 267,
    OF_ACTION_SET_VLAN_VID = 268,
    OF_ACTION_STRIP_VLAN = 269,
    OF_ASYNC_CONFIG_PROP = 270,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_MASTER = 271,
    OF_ASYNC_CONFIG_PROP_EXPERIMENTER_SLAVE = 272,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_MASTER = 273,
    OF_ASYNC_CONFIG_PROP_FLOW_REMOVED_SLAVE = 274,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_MASTER = 275,
    OF_ASYNC_CONFIG_PROP_PACKET_IN_SLAVE = 276,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_MASTER = 277,
    OF_ASYNC_CONFIG_PROP_PORT_STATUS_SLAVE = 278,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_MASTER = 279,
    OF_ASYNC_CONFIG_PROP_REQUESTFORWARD_SLAVE = 280,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_MASTER = 281,
    OF_ASYNC_CONFIG_PROP_ROLE_STATUS_SLAVE = 282,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_MASTER = 283,
    OF_ASYNC_CONFIG_PROP_TABLE_STATUS_SLAVE = 284,
    OF_BSN_CONTROLLER_CONNECTION = 285,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 286,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 287,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 288,
    OF_BSN_GENERIC_STATS_ENTRY = 289,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 290,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 291,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 292,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 293,
    OF_BSN_GENTABLE_STATS_ENTRY = 294,
    OF_BSN_INTERFACE = 295,
    OF_BSN_LACP_STATS_ENTRY = 296,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 297,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 298,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 299,
    OF_BSN_TLV = 300,
    OF_BSN_TLV_ACTOR_KEY = 301,
    OF_BSN_TLV_ACTOR_PORT_NUM = 302,
    OF_BSN_TLV_ACTOR_PORT_PRIORITY = 303,
    OF_BSN_TLV_ACTOR_STATE = 304,
    OF_BSN_TLV_ACTOR_SYSTEM_MAC = 305,
    OF_BSN_TLV_ACTOR_SYSTEM_PRIORITY = 306,
    OF_BSN_TLV_ANCHOR = 307,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 308,
    OF_BSN_TLV_BROADCAST_RATE = 309,
    OF_BSN_TLV_BUCKET = 310,
    OF_BSN_TLV_CIRCUIT_ID = 311,
    OF_BSN_TLV_CONVERGENCE_STATUS = 312,
    OF_BSN_TLV_CRC_ENABLED = 313,
    OF_BSN_TLV_DATA = 314,
    OF_BSN_TLV_DECAP = 315,
    OF_BSN_TLV_ETH_DST = 316,
    OF_BSN_TLV_ETH_SRC = 317,
    OF_BSN_TLV_EXTERNAL_GATEWAY_IP = 318,
    OF_BSN_TLV_EXTERNAL_GATEWAY_MAC = 319,
    OF_BSN_TLV_EXTERNAL_IP = 320,
    OF_BSN_TLV_EXTERNAL_MAC = 321,
    OF_BSN_TLV_EXTERNAL_NETMASK = 322,
    OF_BSN_TLV_GENERATION_ID = 323,
    OF_BSN_TLV_HEADER_SIZE = 324,
    OF_BSN_TLV_ICMP_CODE = 325,
    OF_BSN_TLV_ICMP_ID = 326,
    OF_BSN_TLV_ICMP_TYPE = 327,
    OF_BSN_TLV_IDLE_NOTIFICATION = 328,
    OF_BSN_TLV_IDLE_TIME = 329,
    OF_BSN_TLV_IDLE_TIMEOUT = 330,
    OF_BSN_TLV_IGMP_SNOOPING = 331,
    OF_BSN_TLV_INTERNAL_GATEWAY_MAC = 332,
    OF_BSN_TLV_INTERNAL_MAC = 333,
    OF_BSN_TLV_INTERVAL = 334,
    OF_BSN_TLV_IP_PROTO = 335,
    OF_BSN_TLV_IPV4 = 336,
    OF_BSN_TLV_IPV4_DST = 337,
    OF_BSN_TLV_IPV4_NETMASK = 338,
    OF_BSN_TLV_IPV4_SRC = 339,
    OF_BSN_TLV_IPV6 = 340,
    OF_BSN_TLV_KNOWN_MULTICAST_RATE = 341,
    OF_BSN_TLV_L2_MULTICAST_LOOKUP = 342,
    OF_BSN_TLV_MAC = 343,
    OF_BSN_TLV_MAC_MASK = 344,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 345,
    OF_BSN_TLV_MISS_PACKETS = 346,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 347,
    OF_BSN_TLV_MPLS_LABEL = 348,
    OF_BSN_TLV_MPLS_SEQUENCED = 349,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 350,
    OF_BSN_TLV_NAME = 351,
    OF_BSN_TLV_NEGATE = 352,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 353,
    OF_BSN_TLV_OFFSET = 354,
    OF_BSN_TLV_PARTNER_KEY = 355,
    OF_BSN_TLV_PARTNER_PORT_NUM = 356,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 357,
    OF_BSN_TLV_PARTNER_STATE = 358,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 359,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 360,
    OF_BSN_TLV_PORT = 361,
    OF_BSN_TLV_PORT_VXLAN_MODE = 362,
    OF_BSN_TLV_PRIORITY = 363,
    OF_BSN_TLV_QUEUE_ID = 364,
    OF_BSN_TLV_QUEUE_WEIGHT = 365,
    OF_BSN_TLV_RATE_UNIT = 366,
    OF_BSN_TLV_REFERENCE = 367,
    OF_BSN_TLV_REPLY_PACKETS = 368,
    OF_BSN_TLV_REQUEST_PACKETS = 369,
    OF_BSN_TLV_RX_BYTES = 370,
    OF_BSN_TLV_RX_PACKETS = 371,
    OF_BSN_TLV_SAMPLING_RATE = 372,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 373,
    OF_BSN_TLV_STATUS = 374,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 375,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 376,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 377,
    OF_BSN_TLV_SUB_AGENT_ID = 378,
    OF_BSN_TLV_TCP_DST = 379,
    OF_BSN_TLV_TCP_SRC = 380,
    OF_BSN_TLV_TX_BYTES = 381,
    OF_BSN_TLV_TX_PACKETS = 382,
    OF_BSN_TLV_UDF_ANCHOR = 383,
    OF_BSN_TLV_UDF_ID = 384,
    OF_BSN_TLV_UDF_LENGTH = 385,
    OF_BSN_TLV_UDF_OFFSET = 386,
    OF_BSN_TLV_UDP_DST = 387,
    OF_BSN_TLV_UDP_SRC = 388,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 389,
    OF_BSN_TLV_UNICAST_RATE = 390,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 391,
    OF_BSN_TLV_USE_PACKET_STATE = 392,
    OF_BSN_TLV_VLAN_PCP = 393,
    OF_BSN_TLV_VLAN_VID = 394,
    OF_BSN_TLV_VLAN_VID_MASK = 395,
    OF_BSN_TLV_VNI = 396,
    OF_BSN_TLV_VRF = 397,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 398,
    OF_BSN_VPORT = 399,
    OF_BSN_VPORT_L2GRE = 400,
    OF_BSN_VPORT_Q_IN_Q = 401,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 402,
    OF_BUCKET = 403,
    OF_BUCKET_COUNTER = 404,
    OF_BUNDLE_PROP = 405,
    OF_BUNDLE_PROP_EXPERIMENTER = 406,
    OF_FLOW_STATS_ENTRY = 407,
    OF_GROUP_DESC_STATS_ENTRY = 408,
    OF_GROUP_STATS_ENTRY = 409,
    OF_HELLO_ELEM = 410,
    OF_HELLO_ELEM_VERSIONBITMAP = 411,
    OF_INSTRUCTION = 412,
    OF_INSTRUCTION_APPLY_ACTIONS = 413,
    OF_INSTRUCTION_BSN = 414,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 415,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 416,
    OF_INSTRUCTION_BSN_DENY = 417,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 418,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 419,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 420,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 421,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 422,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 423,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 424,
    OF_INSTRUCTION_BSN_PERMIT = 425,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 426,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 427,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 428,
    OF_INSTRUCTION_CLEAR_ACTIONS = 429,
    OF_INSTRUCTION_EXPERIMENTER = 430,
    OF_INSTRUCTION_GOTO_TABLE = 431,
    OF_INSTRUCTION_ID = 432,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 433,
    OF_INSTRUCTION_ID_BSN = 434,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 435,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 436,
    OF_INSTRUCTION_ID_BSN_DENY = 437,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 438,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 439,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 440,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 441,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 442,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 443,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 444,
    OF_INSTRUCTION_ID_BSN_PERMIT = 445,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 446,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 447,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 448,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 449,
    OF_INSTRUCTION_ID_EXPERIMENTER = 450,
    OF_INSTRUCTION_ID_GOTO_TABLE = 451,
    OF_INSTRUCTION_ID_METER = 452,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 453,
    OF_INSTRUCTION_ID_WRITE_METADATA = 454,
    OF_INSTRUCTION_METER = 455,
    OF_INSTRUCTION_WRITE_ACTIONS = 456,
    OF_INSTRUCTION_WRITE_METADATA = 457,
    OF_MATCH_V1 = 458,
    OF_MATCH_V2 = 459,
    OF_MATCH_V3 = 460,
    OF_METER_BAND = 461,
    OF_METER_BAND_DROP = 462,
    OF_METER_BAND_DSCP_REMARK = 463,
    OF_METER_BAND_EXPERIMENTER = 464,
    OF_METER_BAND_STATS = 465,
    OF_METER_CONFIG = 466,
    OF_METER_FEATURES = 467,
    OF_METER_STATS = 468,
    OF_OXM = 469,
    OF_OXM_ARP_OP = 470,
    OF_OXM_ARP_OP_MASKED = 471,
    OF_OXM_ARP_SHA = 472,
    OF_OXM_ARP_SHA_MASKED = 473,
    OF_OXM_ARP_SPA = 474,
    OF_OXM_ARP_SPA_MASKED = 475,
    OF_OXM_ARP_THA = 476,
    OF_OXM_ARP_THA_MASKED = 477,
    OF_OXM_ARP_TPA = 478,
    OF_OXM_ARP_TPA_MASKED = 479,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 480,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 481,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 482,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 483,
    OF_OXM_BSN_IN_PORTS_128 = 484,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 485,
    OF_OXM_BSN_IN_PORTS_512 = 486,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 487,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 488,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 489,
    OF_OXM_BSN_INNER_ETH_DST = 490,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 491,
    OF_OXM_BSN_INNER_ETH_SRC = 492,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 493,
    OF_OXM_BSN_INNER_VLAN_VID = 494,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 495,
    OF_OXM_BSN_L2_CACHE_HIT = 496,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 497,
    OF_OXM_BSN_L3_DST_CLASS_ID = 498,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 499,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 500,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 501,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 502,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 503,
    OF_OXM_BSN_LAG_ID = 504,
    OF_OXM_BSN_LAG_ID_MASKED = 505,
    OF_OXM_BSN_TCP_FLAGS = 506,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 507,
    OF_OXM_BSN_UDF0 = 508,
    OF_OXM_BSN_UDF0_MASKED = 509,
    OF_OXM_BSN_UDF1 = 510,
    OF_OXM_BSN_UDF1_MASKED = 511,
    OF_OXM_BSN_UDF2 = 512,
    OF_OXM_BSN_UDF2_MASKED = 513,
    OF_OXM_BSN_UDF3 = 514,
    OF_OXM_BSN_UDF3_MASKED = 515,
    OF_OXM_BSN_UDF4 = 516,
    OF_OXM_BSN_UDF4_MASKED = 517,
    OF_OXM_BSN_UDF5 = 518,
    OF_OXM_BSN_UDF5_MASKED = 519,
    OF_OXM_BSN_UDF6 = 520,
    OF_OXM_BSN_UDF6_MASKED = 521,
    OF_OXM_BSN_UDF7 = 522,
    OF_OXM_BSN_UDF7_MASKED = 523,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 524,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 525,
    OF_OXM_BSN_VRF = 526,
    OF_OXM_BSN_VRF_MASKED = 527,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 528,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 529,
    OF_OXM_ETH_DST = 530,
    OF_OXM_ETH_DST_MASKED = 531,
    OF_OXM_ETH_SRC = 532,
    OF_OXM_ETH_SRC_MASKED = 533,
    OF_OXM_ETH_TYPE = 534,
    OF_OXM_ETH_TYPE_MASKED = 535,
    OF_OXM_ICMPV4_CODE = 536,
    OF_OXM_ICMPV4_CODE_MASKED = 537,
    OF_OXM_ICMPV4_TYPE = 538,
    OF_OXM_ICMPV4_TYPE_MASKED = 539,
    OF_OXM_ICMPV6_CODE = 540,
    OF_OXM_ICMPV6_CODE_MASKED = 541,
    OF_OXM_ICMPV6_TYPE = 542,
    OF_OXM_ICMPV6_TYPE_MASKED = 543,
    OF_OXM_IN_PHY_PORT = 544,
    OF_OXM_IN_PHY_PORT_MASKED = 545,
    OF_OXM_IN_PORT = 546,
    OF_OXM_IN_PORT_MASKED = 547,
    OF_OXM_IP_DSCP = 548,
    OF_OXM_IP_DSCP_MASKED = 549,
    OF_OXM_IP_ECN = 550,
    OF_OXM_IP_ECN_MASKED = 551,
    OF_OXM_IP_PROTO = 552,
    OF_OXM_IP_PROTO_MASKED = 553,
    OF_OXM_IPV4_DST = 554,
    OF_OXM_IPV4_DST_MASKED = 555,
    OF_OXM_IPV4_SRC = 556,
    OF_OXM_IPV4_SRC_MASKED = 557,
    OF_OXM_IPV6_DST = 558,
    OF_OXM_IPV6_DST_MASKED = 559,
    OF_OXM_IPV6_EXTHDR = 560,
    OF_OXM_IPV6_EXTHDR_MASKED = 561,
    OF_OXM_IPV6_FLABEL = 562,
    OF_OXM_IPV6_FLABEL_MASKED = 563,
    OF_OXM_IPV6_ND_SLL = 564,
    OF_OXM_IPV6_ND_SLL_MASKED = 565,
    OF_OXM_IPV6_ND_TARGET = 566,
    OF_OXM_IPV6_ND_TARGET_MASKED = 567,
    OF_OXM_IPV6_ND_TLL = 568,
    OF_OXM_IPV6_ND_TLL_MASKED = 569,
    OF_OXM_IPV6_SRC = 570,
    OF_OXM_IPV6_SRC_MASKED = 571,
    OF_OXM_METADATA = 572,
    OF_OXM_METADATA_MASKED = 573,
    OF_OXM_MPLS_BOS = 574,
    OF_OXM_MPLS_BOS_MASKED = 575,
    OF_OXM_MPLS_LABEL = 576,
    OF_OXM_MPLS_LABEL_MASKED = 577,
    OF_OXM_MPLS_TC = 578,
    OF_OXM_MPLS_TC_MASKED = 579,
    OF_OXM_PBB_UCA = 580,
    OF_OXM_PBB_UCA_MASKED = 581,
    OF_OXM_SCTP_DST = 582,
    OF_OXM_SCTP_DST_MASKED = 583,
    OF_OXM_SCTP_SRC = 584,
    OF_OXM_SCTP_SRC_MASKED = 585,
    OF_OXM_TCP_DST = 586,
    OF_OXM_TCP_DST_MASKED = 587,
    OF_OXM_TCP_SRC = 588,
    OF_OXM_TCP_SRC_MASKED = 589,
    OF_OXM_TUNNEL_ID = 590,
    OF_OXM_TUNNEL_ID_MASKED = 591,
    OF_OXM_TUNNEL_IPV4_DST = 592,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 593,
    OF_OXM_TUNNEL_IPV4_SRC = 594,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 595,
    OF_OXM_UDP_DST = 596,
    OF_OXM_UDP_DST_MASKED = 597,
    OF_OXM_UDP_SRC = 598,
    OF_OXM_UDP_SRC_MASKED = 599,
    OF_OXM_VLAN_PCP = 600,
    OF_OXM_VLAN_PCP_MASKED = 601,
    OF_OXM_VLAN_VID = 602,
    OF_OXM_VLAN_VID_MASKED = 603,
    OF_PACKET_QUEUE = 604,
    OF_PORT_DESC = 605,
    OF_PORT_DESC_PROP = 606,
    OF_PORT_DESC_PROP_BSN = 607,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 608,
    OF_PORT_DESC_PROP_BSN_UPLINK = 609,
    OF_PORT_DESC_PROP_ETHERNET = 610,
    OF_PORT_DESC_PROP_EXPERIMENTER = 611,
    OF_PORT_DESC_PROP_OPTICAL = 612,
    OF_PORT_MOD_PROP = 613,
    OF_PORT_MOD_PROP_ETHERNET = 614,
    OF_PORT_MOD_PROP_EXPERIMENTER = 615,
    OF_PORT_MOD_PROP_OPTICAL = 616,
    OF_PORT_STATS_ENTRY = 617,
    OF_PORT_STATS_PROP = 618,
    OF_PORT_STATS_PROP_ETHERNET = 619,
    OF_PORT_STATS_PROP_EXPERIMENTER = 620,
    OF_PORT_STATS_PROP_OPTICAL = 621,
    OF_QUEUE_DESC = 622,
    OF_QUEUE_DESC_PROP = 623,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 624,
    OF_QUEUE_DESC_PROP_MAX_RATE = 625,
    OF_QUEUE_DESC_PROP_MIN_RATE = 626,
    OF_QUEUE_PROP = 627,
    OF_QUEUE_PROP_EXPERIMENTER = 628,
    OF_QUEUE_PROP_MAX_RATE = 629,
    OF_QUEUE_PROP_MIN_RATE = 630,
    OF_QUEUE_STATS_ENTRY = 631,
    OF_QUEUE_STATS_PROP = 632,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 633,
    OF_ROLE_PROP = 634,
    OF_ROLE_PROP_EXPERIMENTER = 635,
    OF_TABLE_DESC = 636,
    OF_TABLE_FEATURE_PROP = 637,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 638,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 639,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 640,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 641,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 642,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 643,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 644,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 645,
    OF_TABLE_FEATURE_PROP_MATCH = 646,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 647,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 648,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 649,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 650,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 651,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 652,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 653,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 654,
    OF_TABLE_FEATURES = 655,
    OF_TABLE_MOD_PROP = 656,
    OF_TABLE_MOD_PROP_EVICTION = 657,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 658,
    OF_TABLE_MOD_PROP_VACANCY = 659,
    OF_TABLE_STATS_ENTRY = 660,
    OF_UINT32 = 661,
    OF_UINT64 = 662,
    OF_UINT8 = 663,
    ...
    /* List objects */
    OF_LIST_ACTION = 664,
    OF_LIST_ACTION_ID = 665,
    OF_LIST_ASYNC_CONFIG_PROP = 666,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 667,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 668,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 669,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 670,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 671,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 672,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 673,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 674,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 675,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 676,
    OF_LIST_BSN_INTERFACE = 677,
    OF_LIST_BSN_LACP_STATS_ENTRY = 678,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 679,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 680,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 681,
    OF_LIST_BSN_TLV = 682,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 683,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 684,
    OF_LIST_BUCKET = 685,
    OF_LIST_BUCKET_COUNTER = 686,
    OF_LIST_BUNDLE_PROP = 687,
    OF_LIST_FLOW_STATS_ENTRY = 688,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 689,
    OF_LIST_GROUP_STATS_ENTRY = 690,
    OF_LIST_HELLO_ELEM = 691,
    OF_LIST_INSTRUCTION = 692,
    OF_LIST_INSTRUCTION_ID = 693,
    OF_LIST_METER_BAND = 694,
    OF_LIST_METER_BAND_STATS = 695,
    OF_LIST_METER_CONFIG = 696,
    OF_LIST_METER_STATS = 697,
    OF_LIST_OXM = 698,
    OF_LIST_PACKET_QUEUE = 699,
    OF_LIST_PORT_DESC = 700,
    OF_LIST_PORT_DESC_PROP = 701,
    OF_LIST_PORT_MOD_PROP = 702,
    OF_LIST_PORT_STATS_ENTRY = 703,
    OF_LIST_PORT_STATS_PROP = 704,
    OF_LIST_QUEUE_DESC = 705,
    OF_LIST_QUEUE_DESC_PROP = 706,
    OF_LIST_QUEUE_PROP = 707,
    OF_LIST_QUEUE_STATS_ENTRY = 708,
    OF_LIST_QUEUE_STATS_PROP = 709,
    OF_LIST_ROLE_PROP = 710,
    OF_LIST_TABLE_DESC = 711,
    OF_LIST_TABLE_FEATURE_PROP = 712,
    OF_LIST_TABLE_FEATURES = 713,
    OF_LIST_TABLE_MOD_PROP = 714,
    OF_LIST_TABLE_STATS_ENTRY = 715,
    OF_LIST_UINT32 = 716,
    OF_LIST_UINT64 = 717,
    OF_LIST_UINT8 = 718,
...
#define OF_MESSAGE_OBJECT_COUNT 206
